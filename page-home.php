...
<body>
    ...
    <main class="container">
        ...
        <section class="banner-section">
            <i class="banner-section-icon banner-section-prev fa-solid fa-chevron-left"></i>
            <div class="banner-section-slide" id="banner-slide">
                <!-- fetch data  -->
            </div>
            <i class="banner-section-icon banner-section-back fa-solid fa-chevron-right"></i>
        </section>
        ...
        <section class="blog-section">
            ...
            <div style="text-align: right; margin-top: 30px">
                <a href="<?php echo home_url("/blog") ?>" class="visit-btn"><span>Go to Blog</span>
                    <i style="font-size: 10px" class="fa-solid fa-chevron-right"></i></a>
            </div>
        </section>
        <!-- CTA Section -->
